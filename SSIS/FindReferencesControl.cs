namespace BIDSHelper.SSIS
{
    ...
    public partial class FindReferencesControl : UserControl
    {
        ...
        public event EventHandler<FindReferencesSelectedEventArgs> FindReferencesSelected;
        ...
        protected virtual void OnRaiseFindReferencesSelected(FindReferencesSelectedEventArgs e)
        {
            // Make a temporary copy of the event to avoid possibility of
            // a race condition if the last subscriber unsubscribes
            // immediately after the null check and before the event is raised.
            EventHandler<FindReferencesSelectedEventArgs> handler = FindReferencesSelected;
        ...
        void expressionGrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (expressionGrid.Columns[e.ColumnIndex] == this.EditorColumn)
                {
                    ...
                    OnRaiseFindReferencesSelected(
                        new FindReferencesSelectedEventArgs(row.Tag as Type,
    ...
    public class FindReferencesSelectedEventArgs : EventArgs
    {
        public FindReferencesSelectedEventArgs(Type type, string objectPath, string expression, string property, string containerID, string objectID, string objectType)
        {
            this.type = type;
